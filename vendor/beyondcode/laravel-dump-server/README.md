...
Bringing the [Symfony Var-Dump Server](https://symfony.com/doc/current/components/var\_dumper.html#the-dump-server) to Laravel.
...
Please see [CONTRIBUTING](../../facade/ignition-contracts/CONTRIBUTING.md) for details.
