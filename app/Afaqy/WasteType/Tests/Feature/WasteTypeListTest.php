...
namespace Afaqy\WasteType\Tests\Feature;

use Tests\TestCase;

class WasteTypeListTest extends TestCase
{
    /** @test */
    public function it_prevents_unauthenticated_user_from_list_waste_types()
    {
    ...
    /** @test */
    public function it_shows_waste_types_list_paginated_by_default()
    {
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
        );
    ...
    /** @test */
    public function it_shows_all_waste_types_list_when_pass_all_pages_parameter()
    {
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
        );
    ...
    /** @test */
    public function it_returns_units_count_that_belonge_to_waste_type()
    {
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
        );
    ...
    /** @test */
    public function it_filters_waste_types_by_name()
    {
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
        );
