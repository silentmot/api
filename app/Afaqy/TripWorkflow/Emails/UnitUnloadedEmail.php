...
class UnitUnloadedEmail extends Mailable implements ShouldQueue
{
    ...
    {
        return $this->subject('تنبيه بالمركبة لم تقم بتفريغ الحمولة في المردم')->markdown('tripworkflow::emails.unit_unloaded');
    }
