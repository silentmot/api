...
class UnitHasNotEntranceWeightEmail extends Mailable implements ShouldQueue
{
    ...
    {
        return $this->subject('تنبيه عدم المرور على ميزان الدخول')->markdown('tripworkflow::emails.entrance_weight_not_exists');
    }
