...
class UnitExceedNetWeightEmail extends Mailable implements ShouldQueue
{
    ...
    {
        return $this->subject('تنبيه بمركبة تجازوت اقصي حد للوزن الصافي')->markdown('tripworkflow::emails.unit_exceed_net_weight');
    }
