...
class UnendedTripEmail extends Mailable implements ShouldQueue
{
    ...
    {
        return $this->subject('تنبيه عدم المرور على ميزان الخروج')->markdown('tripworkflow::emails.unended_trip');
    }
