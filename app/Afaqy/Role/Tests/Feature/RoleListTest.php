...
namespace Afaqy\Role\Tests\Feature;
...
{
    /** @test */
    public function it_prevents_unauthenticated_user_from_list_roles()
    {
    ...
    /** @test */
    public function it_shows_roles_list_paginated_by_default()
    {
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
        );
    ...
    /** @test */
    public function it_shows_all_roles_list_when_pass_all_pages_parameter()
    {
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
        );
    ...
    /** @test */
    public function it_returns_validation_error_when_pass_name_parameter_less_than_two_characters()
    {
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
        );
    ...
    /** @test */
    public function it_filters_roles_names_when_pass_name_parameter()
    {
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
        );
