...
namespace Afaqy\Gate\Tests\Feature;

use Tests\TestCase;

class GateListTest extends TestCase
{
    /** @test */
    public function it_prevents_unauthenticated_user_from_list_gates()
    {
    ...
    /** @test */
    public function it_shows_gates_list_paginated_by_default()
    {
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
        );
    ...
    /** @test */
    public function it_filters_gates_by_name()
    {
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
        );
    ...
    /** @test */
    public function it_filters_gates_by_serial()
    {
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
        );
