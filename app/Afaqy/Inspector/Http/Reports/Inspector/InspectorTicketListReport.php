...
namespace Afaqy\Inspector\Http\Reports\Inspector;
...
class InspectorTicketListReport extends Report
{
    use Generator;
    ...
    {
        return Ticket::withNeighborhood()
            ->select([
            ...
            ->where('mob_inspector_tickets.user_id', auth()->id())
            ->sortBy($this->request)
