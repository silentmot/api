...
namespace Afaqy\UnitType\Tests\Feature;

use Tests\TestCase;

class UnitTypeListTest extends TestCase
{
    /** @test */
    public function it_prevents_unauthenticated_user_from_list_unit_types()
    {
    ...
    /** @test */
    public function it_shows_unit_types_list_paginated_by_default()
    {
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
        );
    ...
    /** @test */
    public function it_shows_all_unit_types_list_when_pass_all_pages_parameter()
    {
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
        );
    ...
    /** @test */
    public function it_returns_units_count_that_belonge_to_unit_type()
    {
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
        );
    ...
    /** @test */
    public function it_filters_unit_types_by_name()
    {
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
        );
