...
use Afaqy\Dashboard\Http\Transformers\WasteTypes\WasteTypesTotalWeightTransformer;

class WasteTypesTotalWeightReport extends Report
{
    use Generator;
    ...
    public function generate()
    {
        return $this->generateJoinViewShow(
            $this->query(),
            new WasteTypesTotalWeightTransformer,
            [],
            false
        );
    }
