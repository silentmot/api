...
namespace Afaqy\Dashboard\Http\Reports\WasteTypes\Exports;
...
class WasteTypesExportData
{
    ...
    public function __construct($data)
    {
        $this->data   = $data;
        $this->header = collect(
            (new WasteTypesDashboardHeaderReport(request()))
                ->show()
                ->getData()
                ->data
        );
    ...
    {
        $result  = [];
        $exclude = ['weight_date', 'total_weight'];
