...
use Afaqy\Dashboard\Http\Transformers\PerHour\PerHourTotalWeightTransformer;

class PerHourTotalWeightReport extends Report
{
    use Generator;
    ...
    public function generate()
    {
        return $this->generateViewShow(
            $this->query(),
            new PerHourTotalWeightTransformer
        );
    }
