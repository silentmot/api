...
namespace Afaqy\Dashboard\Http\Reports\Districts\Exports;
...
class DistrictExportData
{
    ...
    public function __construct($data)
    {
        $this->data   = $data;
        $this->header = collect(
            (new DistrictsDashboardHeaderReport(request()))
                ->show()
                ->getData()
                ->data
        );
    ...
    {
        $result  = [];
        $exclude = ['district_name', 'weight_date', 'total_weight'];
