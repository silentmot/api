...
namespace Afaqy\Permission\Actions\Aggregators\Commercial;
...
use Afaqy\Permission\Actions\Commercial\StoreCommercialPermissionAction;

class StoreCommercialPermissionAggregator extends Aggregator
{
    ...
    public function execute()
    {
        DB::transaction(function () use (&$damaged_projects_permission) {
            $damaged_projects_permission = (new StoreCommercialPermissionAction($this->data->except('units')))->execute();
