...
use Afaqy\Permission\DTO\CommercialPermissionData;
use Afaqy\Permission\Http\Requests\Commercial\CommercialPermissionStoreRequest;
use Afaqy\Permission\Http\Reports\Commercial\CommercialPermissionByNumberReport;
use Afaqy\Permission\Actions\Aggregators\Commercial\StoreCommercialPermissionAggregator;

class CommercialPermissionController extends Controller
{
    /**
     * @SWG\Get(
     *  path="/v1/commercial-damaged-permissions/details/:number",
     *  tags={"Permissions"},
     *  summary="Show commercial permission details by number.",
     *  description="",
     *  operationId="show-permission-commercial-number",
     *  security={
     *      {"passport": {"*"}},
     *  },
     *  @SWG\Parameter(
     *      name="number", type="string", in="query", description="ID/Number for commercial permission.", required=true
     *  ),
    ...
    {
        return (new CommercialPermissionByNumberReport($number))->show();
    }

    /**
     * @SWG\Post(
     *  path="/v1/commercial-damaged-permissions/",
     *  tags={"Permissions"},
     *  summary="Store commercial permission.",
     *  description="",
     *  operationId="commercial-permission-store",
     *  security={
     *      {"passport": {"*"}},
     *  },
     *  @SWG\Parameter(
     ...
     *         @SWG\Property(property="company_commercial_number", type="string", example="12346546"),
     ...
     * )
     */
    public function store(CommercialPermissionStoreRequest $request)
    {
        $dto = CommercialPermissionData::fromRequest($request);

        $result = (new StoreCommercialPermissionAggregator($dto))->execute();
